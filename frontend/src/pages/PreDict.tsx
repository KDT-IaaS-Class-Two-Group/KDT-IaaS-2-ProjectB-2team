...
const Predict: React.FC = () => {
  ...
  return (
    <div className="p-4 flex flex-col items-center justify-center">
        <img
          ...
          alt="description"
          className="w-1080 min-h-1075 object-cover"
        />
              ...
              <div className="w-3/4 flex flex-col items-center">
                ...
                <div className="flex border-[#D9C4B2] w-[198px] h-[72px] border-2">
                  ...
                  <div className="grid grid-cols-3 gap-1 w-3/4 p-1">
                    <div className="bg-[#332F47CC] text-[#C5C1C3] border-[#D9C4B2] border-2 flex justify-center items-center text-center text-[7px]">
                      체력 : 100
                    </div>
                    <div className="bg-[#332F47CC] text-[#C5C1C3] border-[#D9C4B2] border-2 flex justify-center items-center text-center text-[7px]">
                      공격력 : {stat.attack}
  ...
  {log.map((entry, i) => (
    <li
      key={i}
      className="py-2 px-4 bg-[#332F47CC] text-[#C5C1C3] border-[#D9C4B2]"
    >
      {i + 1}일차 : {Object.values(entry).join(", ")}
    </li>
  ))}
</ul>
            </div>
